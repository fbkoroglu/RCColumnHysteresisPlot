...
%% Import Data
for k = 1:numfiles
    myfilename = sprintf('HysteresisData-SI/ID-%d.csv', k);
...
for k=1:numfiles
    ...
    title(['\textbf{Rectangular Column, ID: ', num2str(k), '}'], ...
    ...
    print(h, sprintf('HysteresisPlots-PDF-R/FIG%d.pdf', k), '-dpdf', '-bestfit');
    clf(h)
...
filename = 'TestDataExtremums-R.xlsx';
